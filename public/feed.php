            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="relative">
                    <button class="flex items-center space-x-2 p-2 rounded-full hover:bg-gray-100">
                        <img src="https://ui-avatars.com/api/?name=Jean+Doe&background=3b82f6&color=fff" class="w-8 h-8 rounded-full">
        ...
        <main class="lg:col-span-6">
            ...
            <article class="bg-white rounded-lg shadow mb-4">
                ...
                <div class="p-4 flex items-start justify-between">
                    <div class="flex items-center space-x-3">
                        <img src="https://ui-avatars.com/api/?name=Marie+Dupont&background=10b981&color=fff" class="w-12 h-12 rounded-full">
                        <div>
                ...
                <div class="px-4 pb-4">
                    <p class="text-gray-800 leading-relaxed">
                        Super journée de développement ! J'ai enfin compris comment fonctionnent les sessions PHP et c'est génial 🎉
                    </p>
                </div>
            ...
            <!-- Post Example 2 (with image) -->
            <article class="bg-white rounded-lg shadow mb-4">
                <div class="p-4 flex items-start justify-between">
                    <div class="flex items-center space-x-3">
                        <img src="https://ui-avatars.com/api/?name=Thomas+Martin&background=f59e0b&color=fff" class="w-12 h-12 rounded-full">
                        <div>
                ...
                <div class="px-4 pb-4">
                    ...
                    <img src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=400&fit=crop" class="w-full rounded-lg" alt="Sunset">
                </div>

                <div class="px-4 py-2 border-t border-b border-gray-200 flex items-center justify-between text-sm text-gray-500">
                    <span>❤️ 👍 😍 156 personnes</span>
                    <div class="flex space-x-4">
                ...
                <div class="px-4 py-2 flex items-center justify-around">
                    <button class="flex items-center space-x-2 px-4 py-2 hover:bg-gray-100 rounded-lg transition text-blue-600">
            ...
            <article class="bg-white rounded-lg shadow mb-4">
                <div class="p-4 flex items-start justify-between">
                    <div class="flex items-center space-x-3">
                        <img src="https://ui-avatars.com/api/?name=Sophie+Bernard&background=ec4899&color=fff" class="w-12 h-12 rounded-full">
                        <div>
                            <h3 class="font-semibold text-gray-900">Sophie Bernard</h3>
                ...
                <div class="px-4 pb-4">
                    <p class="text-gray-800 leading-relaxed">
                        Quelqu'un aurait des recommandations pour apprendre le design web ? Je suis plutôt backend mais j'aimerais améliorer mes compétences en CSS ! 💻
                    </p>
                </div>
